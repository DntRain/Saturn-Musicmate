...
exports.apiExplorerMetadata = exports.apiExplorerEndpoints = exports.createApiExplorerEndpoint = exports.apiExplorerOverrides = exports.apiExplorerBaseRoutes = exports.extractRouteParams = exports.stripRouteParams = exports.createApiExplorerId = exports.API_EXPLORER_METADATA_PATH = exports.API_EXPLORER_INDEX_PATH = exports.API_EXPLORER_ROUTE_PATH = void 0;
exports.API_EXPLORER_ROUTE_PATH = '/explorer';
exports.API_EXPLORER_INDEX_PATH = '/explorer/index.html';
exports.API_EXPLORER_METADATA_PATH = '/explorer/metadata';
const humanizeFieldLabel = (value) => value
    .split('_')
    .filter(Boolean)
    .map((segment) => segment.charAt(0).toUpperCase() + segment.slice(1))
    .join(' ');
const createApiExplorerId = (name) => name
    .replace(/([a-z0-9])([A-Z])/g, '$1-$2')
    .replace(/_/g, '-')
    .toLowerCase();
exports.createApiExplorerId = createApiExplorerId;
const stripRouteParams = (routePath) => {
    const strippedPath = routePath.replace(/\/:[A-Za-z0-9_]+\??/g, '');
    return strippedPath || '/';
};
exports.stripRouteParams = stripRouteParams;
const extractRouteParams = (routePath) => {
...
exports.apiExplorerBaseRoutes = [
    ...
    },
    {
        name: 'getComments',
        method: 'GET',
        routePath: '/getComments/:id?/:rootcommentid?/:cid?/:pagesize?/:pagenum?/:cmd?/:reqtype?/:biztype?',
        category: 'Common',
    },
...
const createApiExplorerEndpoint = (route, override = {}) => {
    const generatedQueryParams = (0, exports.extractRouteParams)(route.routePath);
    return {
        id: (0, exports.createApiExplorerId)(route.name),
        name: route.name,
        category: route.category,
        description: `Call ${route.name} endpoint.`,
        method: route.method,
        routePath: route.routePath,
        path: (0, exports.stripRouteParams)(route.routePath),
        queryParams: generatedQueryParams.length ? generatedQueryParams : undefined,
        ...override,
    };
};
exports.createApiExplorerEndpoint = createApiExplorerEndpoint;
exports.apiExplorerEndpoints = exports.apiExplorerBaseRoutes.map((route) => (0, exports.createApiExplorerEndpoint)(route, exports.apiExplorerOverrides[route.name]));
exports.apiExplorerMetadata = {
    title: 'QQ Music API Explorer',
    description: 'A lightweight local API explorer for quick request testing, parameter input, and response preview.',
    endpoints: exports.apiExplorerEndpoints,
};
